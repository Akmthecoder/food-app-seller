...
object Dependencies {
    ...
    object FilePaths {
        const val kotlinQualityGradle = "/commonFiles/gradleScript/kotlin-code-quality.gradle"
    }
    ...
    object Firebase {
        ...
        const val firebase_bom = "com.google.firebase:firebase-bom:${Version.firebaseBOM}"
    ...
    object OkHttp3 {
        ...
        const val okHttp3Intercepter = "com.squareup.okhttp3:logging-interceptor:3.12.1"
    }
    ...
    object ThirdPartiesLib {
        const val reactiveNetwork = "com.github.pwittchen:reactivenetwork-rx2:${Version.reactiveNetwork}"
        const val timber = "com.jakewharton.timber:timber:${Version.timber}"
        const val jodaTime = "joda-time:joda-time:${Version.jodaTime}"
        const val componentManager = "com.github.valeryponomarenko.componentsmanager:androidx:${Version.componentManager}"
        const val mpChart = "com.github.PhilJay:MPAndroidChart:v${Version.mpAndroidChart}"
        const val expandableLayout = "net.cachapa.expandablelayout:expandablelayout:${Version.expandableLayout}"
        const val ProgressWeel = "com.zekapp.library:progreswheelview:${Version.progressWheel}"
        const val ImageSlider = "com.github.smarteist:autoimageslider:${Version.imageSlider}"
        const val permissionDispatcher = "org.permissionsdispatcher:permissionsdispatcher:${Version.permissionDispatcher}"
        const val permissionAnnotation = "org.permissionsdispatcher:permissionsdispatcher-processor:${Version.permissionAnnotation}"
